...
if __name__ == '__main__':
    ...
    popular_articles_results = get_query_results(question_1), question_1_title
    popular_authors_results = get_query_results(question_2), question_2_title
    load_error_days = get_query_results(question_3), question_3_title
